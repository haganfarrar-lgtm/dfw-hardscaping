...
function LeadForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <input type="text" required placeholder="Full Name *" value={formData.name} onChange={(e: any) => setFormData({...formData, name: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-stone-300 bg-white outline-none transition placeholder-stone-400 text-stone-800 focus:ring-2 focus:ring-green-500 focus:border-transparent" />
      <input type="tel" required placeholder="Phone Number *" value={formData.phone} onChange={(e: any) => setFormData({...formData, phone: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-stone-300 bg-white outline-none transition placeholder-stone-400 text-stone-800 focus:ring-2 focus:ring-green-500 focus:border-transparent" />
      <input type="text" required placeholder="Address *" value={formData.address} onChange={(e: any) => setFormData({...formData, address: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-stone-300 bg-white outline-none transition placeholder-stone-400 text-stone-800 focus:ring-2 focus:ring-green-500 focus:border-transparent" />
      <select required value={formData.budget} onChange={(e: any) => setFormData({...formData, budget: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-stone-300 bg-white outline-none transition text-stone-800 focus:ring-2 focus:ring-green-500 focus:border-transparent">
      ...
      <textarea rows={3} placeholder="Tell us about your project..." value={formData.message} onChange={(e: any) => setFormData({...formData, message: e.target.value})} className="w-full px-4 py-3 rounded-xl border border-stone-300 bg-white outline-none transition placeholder-stone-400 text-stone-800 focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none" />
      <button type="submit" disabled={status === 'sending'} className="w-full py-4 bg-stone-800 text-white font-bold rounded-xl hover:bg-stone-900 transition disabled:opacity-50 text-lg">{status === 'sending' ? 'Sending...' : 'Get My Free Estimate'}</button>
